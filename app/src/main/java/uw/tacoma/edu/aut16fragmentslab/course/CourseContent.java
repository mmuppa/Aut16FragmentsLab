package uw.tacoma.edu.aut16fragmentslab.course;
...
public class CourseContent {
    ...
    /**
     * A Course item representing informaton about one course.
     */
    public static class CourseItem implements Serializable {
        ...
        public CourseItem(String id, String content, String shortDescription) {
            this.id = id;
            this.title = content;
